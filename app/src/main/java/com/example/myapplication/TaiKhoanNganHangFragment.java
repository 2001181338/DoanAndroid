...
public class TaiKhoanNganHangFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button btnDoiMkNganHang = view.findViewById(R.id.btnDoiMKNganHang);

        btnDoiMkNganHang.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), DoiMatKhauNganHangActivity.class);
